  ...
  return <section id="servicios" className="section-spacing bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => <div key={index} className="group animate-fade-in-up hover:scale-105 transition-all duration-300" style={{
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center glass p-6 rounded-2xl animate-fade-in-up">
            <div className="text-3xl font-bold text-solar-500 mb-2">15+</div>
            <div className="text-gray-600">Años de experiencia</div>
          </div>
          <div className="text-center glass p-6 rounded-2xl animate-fade-in-up">
            <div className="text-3xl font-bold text-solar-500 mb-2">300+</div>
