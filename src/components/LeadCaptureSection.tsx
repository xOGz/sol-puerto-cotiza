...
const LeadCaptureSection = () => {
  ...
  return (
    <section id="cotizacion" className="section-spacing bg-gradient-to-br from-green-50 via-yellow-50 to-white">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-green-500 to-yellow-500 p-8 rounded-3xl max-w-3xl mx-auto text-white">
